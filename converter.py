...
st.markdown(
    ...
    .stApp {
      background: linear-gradient(135deg, #f3e7e9,rgb(230, 248, 166));
      padding: 30px;
      border-radius: 15px;
...
st.markdown("<h1>🌐 Google-Style Unit Converter</h1>", unsafe_allow_html=True)
...
st.markdown("<div class='footer'>Created with ❤️ by Amna Qureshi</div>", unsafe_allow_html=True)
